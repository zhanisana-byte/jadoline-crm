...
export default function RegisterPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // ✅ SIGN UP — on stocke aussi join_code dans user_metadata
      const { error: signErr } = await supabase.auth.signUp({
        ...
        options: {
          data: {
            ...
            join_code: code || null, // ✅ IMPORTANT POUR /callback
          },
      ...
      // ✅ Sinon, on laisse le trigger SQL créer agence+clé automatiquement
